  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (result?.require2fa) {
        ...
        navigate('/verify-2fa', { state: { email: result.email || formData.email } });
        return;
      }
        ...
        <div className="login-form-container">
          ...
          <div className="login-terms">
            <p>
              ...
              <Link to="#terms" className="login-terms-link">Terms of Service</Link>
              {' '}and{' '}
              <Link to="#privacy" className="login-terms-link">Privacy Policy</Link>
            </p>
          </div>
        </div>
      </div>
